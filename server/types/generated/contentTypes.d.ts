...
export interface ApiDesignerDesigner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    bio: Schema.Attribute.Component<'bio.biography', true>;
    birth: Schema.Attribute.Integer;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    landBirth: Schema.Attribute.String;
    landDeath: Schema.Attribute.String;
    lastname: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiFurnitureFurniture extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    designers: Schema.Attribute.Relation<
      'manyToMany',
      'api::designer.designer'
    >;
    firstProduction: Schema.Attribute.Integer;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
